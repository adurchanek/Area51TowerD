...
public class Node : MonoBehaviour {
...

	{
		...
		//positionOffset = new Vector3( 0,transform.localScale.y/2,0);
...
//			//GameObject _turret = Instantiate(turretBlueprint.upgradedPrefab, this.GetBuildPosition(), GetBuildRotation());
//			this.turret = _turret;
//			upgradedLevel = 2;
//		}
